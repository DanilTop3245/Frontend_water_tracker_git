...
import { ReactComponent as HeartSvg } from '../../assets/svg/gerb.svg';
...
export const ListWrapperOnDescription = styled.li`
  box-shadow: 0px 2px 5px rgba(0, 0, 0, 0.1);
  border-radius: 10px;
  padding: 16px; // Добавляем отступы для текста
...
export const TextTeamPosition = styled.p`
  font-size: 18px;
  font-weight: 400;
  line-height: 1.4; // Увеличиваем line-height для лучшей читаемости
  color: ${(p) => p.theme.colors.primary.text};
